...
const Customwebdesign = () => {
  ...
  return (
    <div>
     <Helmet>
        <title>Custom Web Design Services</title>
        <meta
        ...
        <meta
          property="og:title"
          content="Tailored Web Design Solutions" />
        <meta
          property="og:description"
          content="Tailored web design solutions for visually stunning and user-friendly websites. Explore our design services."/>
      ...
      <div
        ...
        style={{
          background: "url(../../img/customwebdesign.jpg) no-repeat center",
        }}
      >
        ...
        <div className="wrapper">
          <div className="whoweare_inner reverse oneimg row m-0 align-items-md-center">
            ...
            <div className="whoweare_inner_right">
              ...
              <p className="in_r_16">
                Highly scalable, robust and end-to-end Magento ecommerce
                services by Infigrity will help you to manage your store
                seamlessly and give superior user experience to the customers.
              </p>
        ...
        <div className="wrapper">
          <div className="whoweare_inner row m-0 align-items-md-center">
            ...
            <div className="whoweare_inner_right">
              ...
              <p className="in_r_16">
                Infigrity Technologies is a Magento certified company that
                provides superlative Magento eCommerce development services with
                high-quality output. You can always expect optimal deliverables
                from our Magento developers. We believe in delivering only the
                best eCommerce development services to our esteemed clientele at
                a quick turnaround time. We have the acumen of developing
                supreme extensions that are highly ingenious by nature. Your
                online Magento eCommerce store will climb the stairway to
                success once you develop it from us.
              </p>
              <p className="in_r_16">
                A great eCommerce website is all about being responsive,
                user-friendly, and sales generation machine. Whether planning
                for a brand new eCommerce store or want to go for a Magento
                eCommerce web design, we as an all-round Magento eCommerce
                development team deliver a perfect blend of technical expertise,
                by identifying your core needs and implementing the same into
                effective solutions.
              </p>
              <p className="in_r_16">
                Magento is one of the best ecommerce platforms to develop an
                online store. If you are looking for the best Adobe Commerce
                development services, Infigrity is a name to remember. We have a
                full-fledged team that will develop your store from scratch,
                based on your personal business requirements. Hire our
                experienced Magento eCommerce development team now.
              </p>
            ...
            <ul className="row">
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    ...
                    <p className="in_r_16">
                      Our Magento eCommerce developers have the expertise and
                      acumen of developing Magento eCommerce stores that range
                      from simple to most complex ones. Expect high levels of
                      accuracy from us to get maximum results.
                    </p>
                  </div>
                </div>
              </li>
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    ...
                    <p className="in_r_16">
                      We have a team of Magento consultants who will understand
                      your business needs and how Magento can help you to
                      achieve your goals. They will give highly precise and
                      thoughtful Magento consulting services related to Magento
              ...
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    <h3 className="bi_r_24">
                      MAGENTO 1 TO MAGENTO 2 TRANSITION
                    </h3>
                    <p className="in_r_16">
                      Some of our clients want to start from scratch by having a
                      Magento eCommerce store that is developed in Magento 2.
                      Alternatively, we even take the requests to make the
                      transition from Magento 1 to Magento 2 and give first
                      class results at first attempt.
                    </p>
                  </div>
                </div>
              </li>
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    ...
                    <p className="in_r_16">
                      Do you want to shift your existing ecommerce website to
                      Magento? Our skilled Magento professionals will ensure
                      that your website is migrated smoothly and seamlessly
                      while adding and integrating the most suitable features.
                    </p>
                  </div>
                </div>
              </li>
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    ...
                    <p className="in_r_16">
                      We understand that each and every business will have a
                      different requirement so we zero-in on a Magento theme
                      after understanding the crux of your business and then
                      delivering customized Magento theme that is in accordance
              ...
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    ...
                    <p className="in_r_16">
                      We provide the option of customizing your Magento
                      eCommerce store at any given point of time. This means
                      that at any given point of time you can ask us to
                      personalize your online store as per your business
                      requirement.
                    </p>
                  </div>
                </div>
              ...
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    ...
                    <p className="in_r_16">
                      We customize all your Magento development requirements by
                      understanding your business requirements. We even assist
                      you in developing a range of different extensions that
              ...
              <li className="col-md-4">
                <div className="technologies_inner_box">
                  ...
                  <div className="technologies_inner_box_text">
                    ...
                    <p className="in_r_16">
                      Our Magento eCommerce development services do not stop
                      once we have developed your Magento eCommerce online
                      store. We provide support by taking care of all the bugs
                      and minor issues that you face during the initial phase of
                      operation.
                    </p>
                  </div>
                </div>
            ...
            <div className="blog_inner_slider">
              <Slider {...settings}>
                <div className="blog_inner_slider_item">
                  <a href="#">
                    <figure>
                      <img src="../img/Infigrity-Blog-klaviyo.jpg" alt="" />
                      <span>#industry practices</span>
                    </figure>
                    <h3 className="bi_r_24">
                      Why is Klaviyo A Must-have For Any Business?
                    </h3>
                    <p className="in_r_16">
                      As a business owner or marketer, you know how important it
                      is to communicate with your customers. One of the…
                    </p>
                  </a>
                </div>
                <div className="blog_inner_slider_item">
                  <a href="#">
                    <figure>
                      <img
                        src="../img/Unlock-the-unique-benefits-and-features-Pim-Core.jpg"
                        alt=""
                      />
                      <span>#industry practices</span>
                    </figure>
                    ...
                    <p className="in_r_16">
                      When you deal with digital platforms it is essential to
                      make the right choices. Handling multiple tasks becomes
                      challenging and…
                    </p>
                  </a>
                </div>
                <div className="blog_inner_slider_item">
                  <a href="#">
                    <figure>
                      <img
                        src="../img/DIfference-Between-Low-Code-and-Traditional-Develoment-2.jpg"
                        alt=""
                      />
                      <span>#industry practices</span>
                    </figure>
                    <h3 className="bi_r_24">
                      How Does Low Code Development Differ From Traditional
                      Development?
                    </h3>
                    <p className="in_r_16">
                      In this faster-evolving industry, a strategy that brings
                      faster outcomes is important. Low code is a development
